"""
Django settings for CenterServer project.
...
import os
from CenterServer.env_dev import set_env
set_env()
...
ROOT_URLCONF = 'CenterServer.urls'
...
ASGI_APPLICATION = 'CenterServer.asgi.application'

WSGI_APPLICATION = 'CenterServer.wsgi.application'
