...
class publisher:
    ...
    def send_mes(self):
        self.channel.queue_declare(queue='agent_queue_qemu', durable=True,  arguments={'x-message-ttl' : 600000}) # Declare a queue
            # send a message
